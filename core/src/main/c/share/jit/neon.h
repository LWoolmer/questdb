...
namespace questdb::neon {
    ...
    //         c.lea(offset, asmjit::a64::ptr(input, rows_id_offset, 0, i, 0));
    ...
    //     auto value = a64::read_vars_mem(c, type, idx, vars_ptr);
